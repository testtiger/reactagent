        ...
        <ul>
          ...
          <li>
            ...
            <span>
              ...
              <p>I am using items present in state to render line items, which is incorrect</p>
              <p>
                ...
                new props won't be assigned to items object of state so
                always it shows old items
              </p>
              FIX: As Cart is already mounted, consstrucorr won;t
