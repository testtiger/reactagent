  ...
  render() {
    return <div className="container">
        ...
        <form>
          ...
          <div className="row">
            <div className="form-group col-md-3">
            <input value={this.state.criteria.firstName} name="email" type="text" className="form-control" placeholder="Email" />
            </div>
            <div className="form-group col-md-3">
              <input name="zipCode" type="text" className="form-control" placeholder="Zip code" />
            </div>
          </div>
          <div className="row">
            <div className="form-group col-md-3">
