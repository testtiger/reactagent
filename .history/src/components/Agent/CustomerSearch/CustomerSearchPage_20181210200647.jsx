  ...
  render() {
    if (this.state.showRegistrationForm === true) {
      ...
      if(this.state.searchResponse ){
        SearcResultsElement = <SearchResults resp={this.state.searchResponse} onClickProfileInfo={this.onClickProfileInfo.bind(this)} onClickCreateOrderLink={this.onClickCreateOrderLink} />;
      }
