    ...
    profilesList.map((profile)=>{
      ...
      return (
        <tr key={profile.profileDetail.id}>
          ...
          <td>profile.profileDetail.shippingAddress?profile.profileDetail.shippingAddress.phoneNumber:""</td>
          <td>profile.profileDetail.parentOrganization?profile.profileDetail.parentOrganization:""</td>

          <td>profile.latestOrderId?profile.latestOrderId:""</td>
          <td>profile.numberOfOrders?profile.numberOfOrders:0</td>
          <td><a href="">Info...</a></td>
          <td>profile.hasIncompleteOrder.parentOrganization?profile.profileDetail.parentOrganization:""</td>
