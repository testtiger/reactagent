...
import Registration from "../CustomerProfile/CustomerProfilePage";
  ...
  render() {
    if (this.state.showRegistrationForm === true) {
      ...
      let SearcResultsElement = this.state.searchResponse ? (
          <SearchResults resp={this.state.searchResponse} onClickProfileInfo={this.onClickProfileInfo.bind(this)} />
      ) : null;
      return (
