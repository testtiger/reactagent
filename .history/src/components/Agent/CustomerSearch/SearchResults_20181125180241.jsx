      ...
      <div className="Container">
        <div className="row">
          ...
          <table className=" table table-bordered table-responsive ">
            <TableHeader />
            <tbody>
              <TableBody  onSearchResultClick={this.saveProfileAccessed.bind(this)} profilesList={this.props.resp.profileList}  />
            </tbody>
          </table>
        </div>
      </div>
      ...
      return (
        <tr key={profile.profileDetail.id}>
          ...
          <td>
            <button
              onClick={() => {
                props.onSearchResultClick(profile.profileDetail.id);
              }}
            >
              Info...
            </button>
