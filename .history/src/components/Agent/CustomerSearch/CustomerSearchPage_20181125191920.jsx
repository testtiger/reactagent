...
class CustomerSearchPage extends Component {
  ...
  getCustomers() {
    ...
    var uri = "";
    var headers = {};
      var queryParams = { "firstName": "", "lastName": "", "email": "kim", "postalCode": "", "phoneNumber": "", "pageNumber": 0, "limit": 15, "requireCount": false };
  ...
  render() {
    if (this.state.showRegistrationForm === true) {
     ...
     {
        return <CustomerProfilePage profileId={this.state.profileIdFromSearchResult} />;
    } else {
