...
export default class AddressFields extends Component {
  constructor(props) {
    ...
    this.state = { shippingAddress: {
         lastName: "Man", country: "United States", selectedCountry: "US", selectedState: "NY", state_ISOCode: "US-NY", selectedCountry: "US", selectedState: "NY", state_ISOCode: "US-NY", address3: "", address2: "down town", city: "Manhattan", prefix: "", address1: "city street", postalCode: "10007", companyName: "", jobTitle: "", county: "", suffix: "", firstName: "S", phoneNumber: "", faxNumber: "", alias: "Home", middleName: "", state: "New York", email: "yuvi@example1544511307389.com", type: "", isDefaultBillingAddress: false, isDefaultShippingAddress: false, isDefaultAddress: false, stateName: "New York" } };
  }
