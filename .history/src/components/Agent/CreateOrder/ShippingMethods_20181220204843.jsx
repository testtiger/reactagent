...
export default class ShippingMethods extends Component {
  ...
  render() {
    ...
    var self=this
    return this.props.shippingMethodsList.map(function(method) {
      return <a class="dropdown-item" key={method.getId()} href="#" onClick={self.onClickingShippingMethod.bind(self, method.getId())}>
