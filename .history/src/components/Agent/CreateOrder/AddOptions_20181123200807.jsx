...
export default class AddOptions extends Component {
  constructor(props) {
    super(props);
    this.state = { skuId: "", 
    productName: "", response: "", validationMessage: {forSku:"",forName:""} };
  ...
  render() {
    ...
    var validationMessageSpan = this.state.validationMessage.forSku ? <span>
        {this.state.validationMessage.forSku}
      </span> : null;
    var validationMessageSpan1 = this.state.validationMessage.forName ? <span>
