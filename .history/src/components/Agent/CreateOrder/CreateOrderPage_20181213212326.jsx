...
export default class CreateOrderPage extends React.Component {
  ...
  makePriceOrderCall(localState) {
    ...
    if (self.state.items.length > 0 && this.state.orderId !== null) {
      let shoppingCartItems = this.makeShoppingCartWithItems(localState);

      let requestObject = { id: this.state.orderId, shoppingCart: { items: shoppingCartItems }, combineLineItems: "yes", op: "priceOrder", payments: [] };
