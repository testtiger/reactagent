...
export default class AddressFields extends Component {
  ...
  fillAddressForTesting() {
    var shippingAddress = { alias: "123", firstName: "Diwakara", lastName: "k", email: "some1@gmail.com", address1: "line1", address2: "line1", county: "", city: "", state: "", postalCode: "", selectedCountry: "", country: "United States", phoneNumber: "", selectedCountry: "", isDefaultBillingAddress: false, isDefaultShippingAddress: false, isDefaultAddress: false };
  }
  onChange(e) {
