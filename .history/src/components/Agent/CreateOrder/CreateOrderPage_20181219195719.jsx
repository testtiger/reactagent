...
export default class CreateOrderPage extends React.Component {
  ...
  populateShippingMethods() {
    ...
    if (
      !self.state.shippingAddress &&
      self.isShippingAddressValid(self.state.shippingAddress) === false
    ) {
  ...
  render() {
    ...
    if (this.state.availableShippingMethods.length > 0) {
      shippingOptions = (
        <ShippingMethods
          shippingMethodsList={this.state.shippingMethods}
    ...
    return <div className="container">
        ...
        <hr />
        <AddressFields shipping={this.updateShippingAddress.bind(this)} />
