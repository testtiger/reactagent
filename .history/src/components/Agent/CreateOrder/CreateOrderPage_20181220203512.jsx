...
export default class CreateOrderPage extends React.Component {
  ...
  render() {
    ...
    if (
      ...
      shippingOptions = <div>
          <ShippingMethods shippingMethodsList={this.state.availableShippingMethods} selectedMethod={this.selectedShippingMethod.bind(this)} populate={this.populateShippingMethods} />
        </div>;
    }
    return (
