...
export default class CreateOrderPage extends React.Component {
  ...
  shippingAddressChanges(key, value) {
    ...
    if (isShippingAddressValid(newShippingAddress)) {
      this.setState({
  ...
  shippingAddressChanges1(shippingAddressObject) {
    ...
    shippingAddressObject["state_ISOCode"] = shippingAddressObject.setStateISOCode();
    shippingAddressObject["selectedState"] = shippingAddressObject.setSelectedState();
    if (isShippingAddressValid(shippingAddressObject)) {
  ...
  render() {
    return (
      <div className="container">
        ...
        <AddressFields shipping={this.shippingAddressChanges.bind(this)} />
