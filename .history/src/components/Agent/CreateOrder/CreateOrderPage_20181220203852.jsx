    ...
    if (
      ...
      shippingOptions = (
        ...
        <div className="dropdown">
          <button  onClick={this.populateShippingMethods.bind()} className="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Shipping Methods...
          </button>
