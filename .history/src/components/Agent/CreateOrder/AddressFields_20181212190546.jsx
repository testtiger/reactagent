...
export default class AddressFields extends Component {
  render() {
    return <div>
        ...
        <div className="row">
          <div className="form-group col-sm-4">
            <input type="text" class="col-md-12 form-control" name="zip" id="addressBook-zip" aria-required="true" required="required" placeholder="city" />
          </div>
          <div className="form-group col-sm-4">
                <input type="text" class="col-md-12 form-control" name="phoneNumber" id="addressBook-phoneNumber" aria-required="true" required="required" placeholder="city" />
          </div>
        </div>
      </div>;
