...
export default class CreateOrderPage extends React.Component {
  ...
  shippingAddressChanges(key, value) {
    let setSelectedState = function() {
      return this.state;
    };
    let setStateISOCode = function() {
    ...
    if (newShippingAddress[key]) {
      newShippingAddress[key] = value;
    }
    newShippingAddress["state_ISOCode"] = newShippingAddress.setStateISOCode();
    newShippingAddress["selectedState"] = newShippingAddress.setSelectedState();
    if (this.isShippingAddressValid(newShippingAddress)) {
      this.setState({
  ...
  shippingAddressChanges1(shippingAddressObject) {
    ...
    let setStateName = function () {
      return this.state;
    };

    shippingAddressObject["state_ISOCode"] = setStateISOCode.bind(shippingAddressObject);
    shippingAddressObject["selectedState"] = setSelectedState.bind(shippingAddressObject);
    shippingAddressObject["stateName"] = setSelectedState.bind(shippingAddressObject);
