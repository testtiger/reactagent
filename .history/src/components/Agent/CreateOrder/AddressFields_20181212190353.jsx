...
export default class AddressFields extends Component {
  render() {
    return <div>
        ...
        <div className="row">
            <input type="text" class="col-md-12 form-control" name="addressLine1" id="addressBook-saddress2" aria-required="true" required="required" placeholder="Address Line 2" />
        </div>
        <div className="row">
