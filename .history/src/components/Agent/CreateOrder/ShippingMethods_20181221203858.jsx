...
export default class ShippingMethods extends Component {
  ...
  render() {
    ...
    var sm = this.props.shippingMethodsList.map(function(method) {
      return <li>
          <a class="dropdown-item" key={method.getId()} href="#" onClick={self.onClickingShippingMethod.bind(self, method.getId())}>
            {method.getDisplayName()}
          </a>
        </li>;
    });
    return <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
        {sm}
      </ul>;
    //return sm;
  }
