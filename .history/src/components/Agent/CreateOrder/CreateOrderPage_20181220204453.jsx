    ...
    return <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-sm-5">
            <div className="row">
              <button className="btn btn-primary" onClick={this.populateShippingMethods.bind(this)}>
                LoadShippingMethods
              </button>
            </div>
            <div className="row">
              <div col-sm-9>{shippingOptions}</div>
            </div>
          </div>
        </div>
        ...
        <div className="dropdown">
          <button onClick={this.populateShippingMethods.bind(this)} className="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Shipping Methods...
          </button>
