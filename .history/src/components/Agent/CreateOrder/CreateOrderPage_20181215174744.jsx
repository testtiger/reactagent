...
export default class CreateOrderPage extends React.Component {
  ...
  shippingAddressChanges1(shippingAddressObject) {
    ...
    shippingAddressObject["state_ISOCode"] = setStateISOCode.call(shippingAddressObject);
    shippingAddressObject["selectedState"] = setSelectedState.call(shippingAddressObject);
    shippingAddressObject["stateName"] = setSelectedState.call(shippingAddressObject);
