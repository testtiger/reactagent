...
export default class AddressFields extends Component {
  render() {
    return <div>
        ...
        <div className="row">
            <input type="text" class="col-md-12 form-control" name="sAddressLine1" id="addressBook-address1" aria-required="true" required="required" placeholder="Address Line 1" />
        </div>
        <div className="row">
        ...
        <div className="form-group col-sm-4">
          <select class="col-md-12 form-control" name="sState" id="CC-checkoutAddressBook-sstate" aria-required="true" data-bind="enable: stateList().length, options: stateList, optionsText: 'displayName', optionsValue: 'abbreviation',
                     ...
                     validatableTarget: state, validationElement: state"><option value="">State/Region</option><option value="B">Buenos Aires</option><option value="K">Catamarca</option><option value="H">Chaco</option><option value="U">Chubut</option><option value="C">Ciudad Autónoma de Buenos Aires</option><option value="X">Cordoba</option><option value="W">Corrientes</option><option value="E">Entre Rios</option><option value="P">Formosa</option><option value="Y">Jujuy</option><option value="L">La Pampa</option><option value="F">La Rioja</option><option value="M">Mendoza</option><option value="N">Misiones</option><option value="Q">Neuquén</option><option value="R">Rio Negro</option><option value="A">Salta</option><option value="J">San Juan</option><option value="D">San Luis</option><option value="Z">Santa Cruz</option><option value="S">Santa Fe</option><option value="G">Santiago del Estero</option><option value="V">Tierra del Fuego</option><option value="T">Tucumán</option>
                        </select>
        </div>
      </div>;
