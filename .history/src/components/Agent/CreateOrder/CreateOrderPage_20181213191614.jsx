...
import { makeGetCall, getURIList, makePostCall } from "../Rest/agent-rest-client";
//OrderSummary
export default class CreateOrderPage extends React.Component {
  ...
  makeCreateOrderCall() {
    ...
    if (this.state.items.length > 0 && this.orderId !== null) {
      ...
      makePostCall("/ccagentui/v1/orders");
      let queryParams = {  };
      var headers = { Authorization: sessionStorage.getItem("token") };
      makePostCall(getURIList()["GET_SKU"] + skuId, headers, queryParams).then(
    }
  }
  addBySku1(e) {
    var skuId = e;
