...
export default class AddressFields extends Component {
                 constructor(props) {
                   super(props);
                   this.state = { shippingAddress: { alias: "Home", firstName: "S", lastName: "Man", email: "yuvi@example1544511307389.com", address1: "city street", address2: "down town", city: "Manhattan", state: "New York", stateName: "New York", postalCode: "10007", country: "United States", selectedCountry: "US", selectedState: "NY", state_ISOCode: "US-NY", selectedCountry: "US", selectedState: "NY", state_ISOCode: "US-NY", phoneNumber: "", isDefaultBillingAddress: false, isDefaultShippingAddress: false, isDefaultAddress: false } };
                 }
