...
export default class AddressFields extends Component {
  render() {
    return <div>
        ...
        <div className="row">
            <input type="text" class="col-md-12 form-control" name="sAddressLine2" id="CC-checkoutAddressBook-saddress1" aria-required="true" required="required" placeholder="Address Line 1" />
        </div>
      </div>;
