...
export default class Cart extends Component {
  ...
  render() {
    var cartContent = [];
    // As I have initiate items in the constructor : is is caused the problme when I add a new Item
    // As Cart is already mounted consstrucorr won;t be called & second time . thouh I send 
