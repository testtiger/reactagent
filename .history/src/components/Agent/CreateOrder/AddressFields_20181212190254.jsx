...
export default class AddressFields extends Component {
  render() {
    return <div>
        ...
        <div className="form-group col-sm-4">
          <select class="col-md-12 form-control invalid" name="sState" id="CC-checkoutAddressBook-sstate" aria-required="true" data-bind="enable: stateList().length, options: stateList, optionsText: 'displayName', optionsValue: 'abbreviation',
