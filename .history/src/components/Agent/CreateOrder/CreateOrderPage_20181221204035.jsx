        ...
        <div className="row">
          ...
          <div className="col-sm-5">
            <div className="dropdown">
              <button onClick={this.populateShippingMethods.bind(this)} className="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown">
                Shipping Methods...
              </button>
              <button onClick={this.populateShippingMethods.bind(this)} className="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                Shipping Methods...
                <span class="caret" />
              </button>
