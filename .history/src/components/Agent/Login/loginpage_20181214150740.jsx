...
export default class LoginPage extends Component {
  constructor(props) {
    ...
    if (!window.localStorage.getItem("token")) {
      ...
      sessionStorage.setItem("isLoggedin", window.localStorage.setItem("isLoggedin", true));
    } else {
      sessionStorage.setItem("isLoggedin", false);
      sessionStorage.setItem("token", null);
    }
    this.state = { username: "", password: "", isLoggedin: sessionStorage.getItem("isLoggedin") };
