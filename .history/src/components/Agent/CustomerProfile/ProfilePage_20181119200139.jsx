...
class ProfilePage extends Component{
    ...
    render(){
        ler response = this.state.getProfileResponse ? this.state.getProfileResponse:null;
        
        var profileDetail = this.state.profileId ? <profileDetail 
        firstName={this.state.getProfileResponse}/>:null
