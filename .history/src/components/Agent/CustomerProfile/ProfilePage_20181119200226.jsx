...
class ProfilePage extends Component{
    ...
    render(){
        let profielDetaisl = this.state.getProfileResponse ? this.state.getProfileResponse.profileDetail : null;
        
        var profileDetail = this.state.profileId ? <profileDetail firstName={response}/>:null
