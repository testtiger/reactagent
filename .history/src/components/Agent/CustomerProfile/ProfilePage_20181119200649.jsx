...
class ProfilePage extends Component {
  ...
  render() {
    ...
    if (this.state.profileId) {
      profileInfo = <profileDetail firstName={profileDetails.firstName} lastName={profileDetails.firstName} email={profileDetails.email} receiveEmail={profileDetails.receiveEmail} />;
    }
